...
class Home extends CI_Controller
{
    ...
    */
    ...
    public function unsubscribe($contact_id,$email)
    {
        ...
        $data = array();
        $convertidintobinary = urldecode($contact_id);
    ...
    public function unsubscribe_action()
    {
        ...
        if(isset($btntype) && !empty($btntype) && $btntype == "unsub")
        {
            if($contactType == "contact") {
                ...
                if($this->basic->update_data("messenger_bot_subscriber", array("id"=>$contactid,"email"=>$email_address), array("is_email_unsubscriber"=>"1"))) {
                    echo "1";
                } else {
                    echo "0";
                }
        ...
        } else if(isset($btntype) && !empty($btntype) && $btntype == "sub")
        {
            if($contactType == "contact") {
                ...
                if($this->basic->update_data("messenger_bot_subscriber", array("id"=>$contactid,"email"=>$email_address), array("is_email_unsubscriber"=>"0")))
                {
                    echo "1";
