                  ...
                  <div class="card-header">
                    <h4><i class="fas fa-circle"></i> 
                      <?php echo $this->lang->line("Subscriber Background Scan & Migrated Bot Subscriber Profile Info Update");?>
                        <?php if($this->basic->is_exist("add_ons",array("project_id"=>30))) echo " & ".$this->lang->line("Sequence Message"); ?> 
                  ...
                  <div class="card-header">
                    <h4>
                      ...
                      <?php if($this->basic->is_exist("add_ons",array("project_id"=>29))) : ?>
                        ...
                        <?php if($this->basic->is_exist("add_ons",array("project_id"=>33))) echo " & ".$this->lang->line("WC Abandoned Cart"); ?>
