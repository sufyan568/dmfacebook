                            ...
                            <div class="row" id="campaign_details">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="message" name="message" class="form-control" placeholder="<?php echo $this->lang->line("type your message here...") ?>"><?php if(isset($campaign_data[0]['email_message'])) echo $campaign_data[0]['email_message']; else echo set_value('message');?></textarea>
                                    </div>
                                </div>
