...
<body>
	<div class="container">
		<div class="inner-container">
			...
			<div class="bottom">
				<h4 class="title"><?php echo $this->lang->line('Do you want to unsubscribe?'); ?></h4>
				<p class="subtitle"><?php echo $this->lang->line('If you unsubscribe, you will stop receiving our emails.'); ?><p/>
			...
			$(document).on('click', '#unsubscribe', function(event) {
				...
				if(contactid != '' || email != '')
				{
					$.ajax({
						...
						type: 'POST',
						data: {contactid: contactid, email:email, btntype:btntype, contactType:contactType},
