...
class Comboposter extends Home
{
    ...
    public function campaigns_info_data($campaign_type)     
    {
        ...
        $display_columns = array("#",'id','campaign_name','posting_medium', 'action','posting_status','schedule_time');
        ...
        {   
            ...
            $info[$i]['action'] .= ' <a href="'. base_url('comboposter/'.$campaign_type.'_post/clone/'.$info[$i]['id']) .'" class="btn btn-outline-info btn-circle" data-toggle="tooltip" data-placement="top" data-title="'. $this->lang->line("Clone this campaign") .'"><i class="fa fa-clone"></i></a> <a href="'. base_url('comboposter/'.$campaign_type.'_post/report/'.$info[$i]['id']) .'" class="btn btn-outline-primary btn-circle" data-toggle="tooltip" data-placement="top" data-title="'. $this->lang->line("View campaign report") .'"><i class="fas fa-eye"></i></a> <a href="#" class="btn btn-outline-danger btn-circle delete_campaign" table_id="'. $info[$i]['id'] .'" data-toggle="tooltip" data-placement="top" data-title="'. $this->lang->line("Delete this app") .'"><i class="fas fa-trash-alt"></i></a></div><script>$(\'[data-toggle="tooltip"]\').tooltip();</script>';
    ...
    private function post_to_all_media_action($post_type = "", $post_content = "", $selected_social_media = "")
    {
        ...
        foreach($selected_social_media as $single_media)
        {
            ...
            } else if(strpos($single_media, 'twitter') !== false) {
            ...
            } else if(strpos($single_media, 'reddit') !== false) {
            ...
            } else if(strpos($single_media, 'pinterest') !== false) {
            ...
            } else if(strpos($single_media, 'linkedin') !== false) {
            ...
            } else if(strpos($single_media, 'wordpress') !== false) {
