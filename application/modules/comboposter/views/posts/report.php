          ...
          <div class="card">
            ...
            <div class="card-body data-card">
              ...
              <?php if (($campaign_type == 'image' || $campaign_type == 'html') && $campaigns_info['rich_content'] != ''): ?>
                ...
                <div class="section-lead"><?php echo htmlspecialchars_decode($campaigns_info['rich_content']); ?></div>
              <?php endif ?>
                                            ...
                                            <li class="list-group-item list-group-item-action">
                                                <div class="row">
                                                  ...
                                                  <div class="col-10 col-md-3">                                    
                                                    <a class="btn btn-outline-primary btn-rounded float-right" href="<?php echo isset($report['report']) ? $report['report'] : ''; ?>"><?php echo $this->lang->line("Visit Post"); ?></a>
                                                  </div>
                                                </div>
