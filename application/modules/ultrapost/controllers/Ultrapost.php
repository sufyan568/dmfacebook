...
class Ultrapost extends Home
{
    ...
    public function text_image_link_video_auto_post_list_data()
    {
        ...
        $select = array("facebook_rx_auto_post.*","facebook_rx_fb_page_info.page_id AS pageid");
        $join   = array('facebook_rx_fb_page_info'=>"facebook_rx_fb_page_info.id=facebook_rx_auto_post.page_group_user_id,left");
